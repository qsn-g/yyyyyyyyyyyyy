...
var author$project$Main$pick = _Platform_outgoingPort('pick', elm$json$Json$Encode$int);
	...
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				...
				return _Utils_Tuple2(
					model,
					author$project$Main$pick(state));
		}
	});
...
var author$project$Main$Select_index = function (a) {
	return {$: 'Select_index', a: a};
};
									...
									[
										...
										_List_fromArray(
											[
												...
												author$project$Main$Select_index(1))
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												elm$html$Html$Events$onClick(
												author$project$Main$Select_index(2))
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												elm$html$Html$Events$onClick(
												author$project$Main$Select_index(3))
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												elm$html$Html$Events$onClick(
												author$project$Main$Select_index(4))
											]),
										_List_fromArray(
											[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Events$onClick(
												author$project$Main$Select_index(5))
											]),
										_List_fromArray(
											[
												elm$html$Html$text('None')
										...
										_List_fromArray(
											[
												elm$html$Html$Events$onClick(
												author$project$Main$Select_index(6))
											]),
										_List_fromArray(
											[
												elm$html$Html$text('Number of People')
